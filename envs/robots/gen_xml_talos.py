...
JVRC_DESCRIPTION_PATH="/home/nico/Documents/LearningHumanoidWalking/models/Talos/talos.xml"
...
def builder(export_path):
    ...
    leg_joints = [
        'hip_rotation_l', 'hip_adduction_l', 'hip_flexion_l',
        'knee_angle_l', 'ankle_angle_l', 
        'hip_rotation_r', 'hip_adduction_r', 'hip_flexion_r',
