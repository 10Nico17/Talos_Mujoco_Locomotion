...
from tasks import jvrc_walking_task
...
from .gen_xml_jvrc import builder
...
class JvrcWalkEnv(mujoco_env.MujocoEnv):
    def __init__(self):
        ...
        path_to_xml_out = '/home/nico/Documents/Talos_Mujoco_Locomotion/models/Jvrc/tmp/jvrc1.xml'
        ...
        #path_to_xml_out = '/home/nico/Documents/LearningHumanoidWalking/models/jvrc_mj_description/xml/scene.xml'
        ...
        '''
        'PELVIS_S': Der zentrale Körper des Roboters, üblicherweise der Rumpf oder das Becken (Pelvis).
        'L_ANKLE_P_S': Körperteil, der den linken Fuß oder das linke Sprunggelenk (Ankle) des Roboters repräsentiert
        '''
        # set up task
        self.task = jvrc_walking_task.WalkingTask(client=self.interface,
                                             dt=control_dt,
        ...
        self.observation_space_size = len(self.observation_space)
