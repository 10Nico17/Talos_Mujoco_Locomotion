...
def train(args):
    ...
    print("critic.obs_mean: ", critic.obs_mean)
    print("critic.obs_mean: ", len(critic.obs_mean))

    print("critic.obs_std: ", critic.obs_std)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_itr", type=int, default=200, help="Number of iterations of the learning algorithm")
    ...
    parser.add_argument("--no_mirror", default=True, required=False, action="store_true", help="to use SymmetricEnv")
